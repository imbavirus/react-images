...
var Lightbox = function (_Component) {
	...
	function Lightbox(props) {
		...
		_bindFunctions2.default.call(_this, ['gotoNext', 'gotoPrev', 'closeBackdrop', 'rotate', 'counterRotate', 'handleKeyboardInput', 'handleImageLoaded']);
		return _this;
	}
	...
	_createClass(Lightbox, [{
		...
		value: function renderHeader() {
			...
			return _react2.default.createElement(_Header2.default, {
				...
				onCounterRotate: this.counterRotate,
...
Lightbox.propTypes = {
	...
	rotateButtonTitle: _propTypes2.default.string,
